...
<div class="twitter-bootstrap crud-form">
	...
	<h2 class="span12"><?php echo $this->l('list_record'); ?> <?php echo $subject?></h2>

	<!-- CONTENT FOR ALERT MESSAGES -->
	<div id="message-box" class="span12"></div>
	<div id="main-table-box span12">
		<?php
		echo form_open( '#', 'method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data"');
			...
			<?php 	if(!$this->unset_back_to_list) { ?>
				<input type='button' value='<?php echo $this->l('form_back_to_list'); ?>' class='btn btn-large btn-primary back-to-list' id="cancel-button" />
