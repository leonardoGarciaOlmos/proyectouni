...
var alert_message = function(type_message, text_message){
    ...
    $('#message-box').prepend('<div id="alert-message" class="alert '+type_message+' modal-message"><span class="icon"></span><span class="close">x</span>'+text_message+'</div>');
    $('html, body').animate({
        scrollTop:0
    }, 600);
        ...
        success: function(data){
            ...
            else
            {
                ...
                $.each(data.error_fields, function(index,value){
                    ...
                    $("div.modal-message."+index).remove();
                    $('[name='+index+']').addClass('error');
                    $('[name='+index+']').after('<div class="alert modal-message '+index+' '+value+'"><span class="icon"></span><span class="close">x</span>'+value+'</div>');
