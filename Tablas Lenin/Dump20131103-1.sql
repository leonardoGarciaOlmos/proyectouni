...
CREATE TABLE `materia_has_pensum` (
  ...
  CONSTRAINT `fk_materia_has_pensum_materia1` FOREIGN KEY (`materia_codigo`) REFERENCES `materia` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_materia_has_pensum_pensum1` FOREIGN KEY (`pensum_id`) REFERENCES `pensum` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `materia_has_pensum` VALUES ('ANS0122',1,1),('LEC0143',1,1),('TDC0103',1,1);
...
CREATE TABLE `pensum` (
  ...
  CONSTRAINT `fk_pensum_carrera1` FOREIGN KEY (`carrera_id`) REFERENCES `carrera` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
INSERT INTO `pensum` VALUES (1,'2013-10-17','ACTIVO',1);
...
-- Dump completed on 2013-11-03 13:10:04
